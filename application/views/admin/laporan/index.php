	...
	<div class="card shadow">
		<div class="card-body">
			<div class="table-responsive">
				...
				<div align="right">
					<a class="btn btn-sm btn-primary mb-3 col-md-2" target="_blank" href="<?= base_url('admin/laporan/cetak') ?>"><i class="fas fa-print fa-sm"></i> Cetak</a>
				</div>
					<thead>
						<tr>
					...
					<tbody>
						...
						foreach ($distribusi as $value) : ?>
							<tr class = "text-center">
								...
								<td>
									<a class="btn btn-sm btn-primary m-1" href="<?= base_url('admin/laporan/detail/'.$value->id_pengiriman) ?>"><i class="fas fa-eye fa-sm"></i></a>
								</td>
							</tr>
						<?php endforeach; ?>
					</tbody>
