						...
						foreach ($bantuan as $value) : ?>
							<tr class = "text-center">
								...
								<td>
                                    ...
                                    <a class="btn btn-danger btn-sm m-1 hapus" href="<?= base_url('pimpinan/bantuan/delete/'.$value->id_bantuan) ?>"><i class="fas fa-trash"></i></a>
								</td>
							</tr>
						<?php endforeach; ?>
					</tbody>
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Tambah Daftar Bantuan Non Stunting</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
        	<span area-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
        <form action="<?= base_url('pimpinan/bantuan/add') ?>" method="post" enctype="multipart/form-data">
...
<?php foreach ($bantuan as $value): ?>
<div class="modal fade" id="edit<?= $value->id_bantuan ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Edit Bantuan Non Stunting</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
        	<span area-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
        <form action="<?= base_url('pimpinan/bantuan/edit/'.$value->id_bantuan) ?>" method="post" enctype="multipart/form-data">
                <div class="form-group">
                    <label>Nama Bantuan</label>
